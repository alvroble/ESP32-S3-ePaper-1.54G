...
#define DRIVER_PIXEL_BITS        2          // 四色像素占2bit
#define DRIVER_PIXELS_PER_BYTE   (8 / DRIVER_PIXEL_BITS)  // 1字节存4个像素
#define DRIVER_BYTES_PER_LINE(w) ((w + DRIVER_PIXELS_PER_BYTE - 1) / DRIVER_PIXELS_PER_BYTE) // 每行字节数
